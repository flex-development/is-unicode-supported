...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/is-unicode-supported
   cd is-unicode-supported
   ```
...
```sh
https://github.com/flex-development/is-unicode-supported/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/is-unicode-supported/discussions/new?category=q-a
